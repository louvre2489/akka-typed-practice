...
import practice.akka.iot.Device.{Passivate, RecordTemperature, TemperatureRecorded}
import practice.akka.iot.DeviceManager.{DeviceRegistered, ReplyDeviceList, RequestAllTemperatures, RequestDeviceList, RequestTrackDevice, RespondAllTemperatures, Temperature, TemperatureNotAvailable}
